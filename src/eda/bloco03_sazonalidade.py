...
def main() -> None:
    ...
    tipos = ["Dia útil", "Sábado", "Domingo", "Feriado", "Recesso"]
    ...
    for s in TODOS:
        ...
        for i in range(1, 8):
            vals = [v for d, v in nucleo.items() if d.isoweekday() == i and dim[d]["Feriado"] == "Não" and dim[d]["PontoFacultativo"] == "-" and dim[d]["Recesso"] == "Não"]
    ...
    ax.set_title("Dia da semana (sem feriados, pontos facultativos e recesso), 2024–2025")
